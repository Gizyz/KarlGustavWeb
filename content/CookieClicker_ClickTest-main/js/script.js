...
const workers = [
  ...
  { name: "Manager Nelson", cost: 5000, amount: 0, clicks: 100 },
  { name: "Managing manager Dobin", cost: 10000, amount: 0, clicks: 1000 },
  { name: "CEO Koblan", cost: 50000, amount: 0, clicks: 10000 },
  { name: "Leader Vaslab", cost: 100000, amount: 0, clicks: 100000 },
  { name: "Cat Budha", cost: 1000000, amount: 0, clicks: 1000000 },
];
...
function workerUpgrade(e) {
  ...
  if (cookieAmount >= workers[buttonIndex].cost) {
    ...
    //Cost increase
    workers[buttonIndex].cost += Math.floor(
      1.00001 * workers[buttonIndex].amount
    );
    cookieDisplay();
  }

  console.log(workers[buttonIndex]);
  ...
  console.log("Name: " + workers[buttonIndex].name);
  console.log("Workers: " + workers[buttonIndex].amount);
}
